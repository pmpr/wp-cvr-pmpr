...
<div class="shop_table woocommerce-checkout-review-order-table">
    <div class="card border-gray-300 mb-0 mb-xl-2">
        <div class="card-body">
            <h2 class="h5 font-weight-normal mb-4"><?php esc_html_e('Order Details', PR__THM__PMPR) ?></h2>
            ...
            <ul class="list-group list-group-flush list-group-compact">
				...
				foreach (WC()->cart->get_cart() as $key => $item) {
					...
					if ($_product instanceof WC_Product && $_product->exists() && $item['quantity'] > 0
						...
						$quantity = apply_filters('woocommerce_widget_cart_item_quantity', sprintf('%s <span class="text-muted">|</span> %s', sprintf(__('%s Number', PR__THM__PMPR), $item['quantity']), $price), $item, $key);
